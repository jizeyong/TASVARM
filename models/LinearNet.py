...
from models.module.LinearTransformer import LinearTransformer
from models.module.Executor import Executor
from utils.tools import AverageMeter
import torch.nn.functional as F
from torch.nn.parallel import DistributedDataParallel as DDP
class LinearNet(nn.Module):
    def __init__(self, class_embed, class_list, num_frames=16, num_layers=6, num_heads=8, qkv_bias=False,
                 qk_scale=None, attn_drop=0., proj_drop=0., drop_path=0.1, dropout=0.1,
                 image_mode="openai/clip-vit-base-patch16", text_mode="openai/clip-vit-base-patch32"):
        super().__init__()
        ...
        self.transformer = LinearTransformer(self.embed_dim, num_frames, num_layers, num_heads, qkv_bias,
                                                  qk_scale, attn_drop, proj_drop, drop_path, dropout)
...
class LinearNet_Executor(Executor):
    def __init__(self, criterion, eval_metric, eval_metric_string, class_list, num_frames, working_dir,project_path, device,
                 args) -> None:
        super().__init__(criterion, eval_metric, eval_metric_string, class_list, working_dir,project_path, device,args)
