...
from models.module.AddTransformer import AddTransformer
...
class AddNet(nn.Module):
    def __init__(self, class_embed, class_list, num_frames=16, num_layers=6, num_heads=8, qkv_bias=False,
        ...
        self.transformer = AddTransformer(self.embed_dim, num_frames, num_layers, num_heads, qkv_bias,
...
class AddNet_Executor(Executor):
