...
from models.module.MultiTransformer import MultiTransformer
...
class MultiNet(nn.Module):
    def __init__(self, class_embed, class_list, num_frames=16, num_layers=6, num_heads=8, qkv_bias=False,
        ...
        self.transformer = MultiTransformer(self.embed_dim, num_frames, num_layers, num_heads, qkv_bias,
...
class MultiNet_Executor(Executor):
    def __init__(self, criterion, eval_metric, eval_metric_string, class_list, num_frames, working_dir,project_path, device,
                 args) -> None:
        super().__init__(criterion, eval_metric, eval_metric_string, class_list,working_dir,project_path, device,
                 args)
